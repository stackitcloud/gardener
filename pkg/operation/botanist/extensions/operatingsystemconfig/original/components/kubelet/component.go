...
func (component) Config(ctx components.Context) ([]extensionsv1alpha1.Unit, []extensionsv1alpha1.File, error) {
	...
	case extensionsv1alpha1.CRINameDocker:
		execPreStart = execStartPreCopyBinaryFromContainer("kubelet", ctx.Images[common.HyperkubeImageName], ctx.KubernetesVersion)
	case extensionsv1alpha1.CRINameContainerD:
		execPreStart = execStartPreCopyBinaryFromContainerForContainerD("kubelet", ctx.Images[common.HyperkubeImageName], ctx.KubernetesVersion, ctx.ProxyConfig)
	}
