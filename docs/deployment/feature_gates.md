...
| OpenTelemetryCollector         | `gardenlet`, `gardener-operator`                    | Routes logs through an instance of an `OpenTelemetry Collector` in the control-plane of `Shoots` and the `garden` namespace of `Seed` and `Garden` clusters.                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
