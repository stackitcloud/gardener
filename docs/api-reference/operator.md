...
<td>
<em>(Optional)</em>
<p>Ingress contains configuration for the ingress settings.<br />Deprecated: This field is deprecated and will be removed in a future version. Use the Domain field field for<br />customizing the ingress domain instead.</p>
</td>
</tr>
<tr>
<td>
