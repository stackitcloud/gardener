...
<tr>
<td>
<code>selfHostedShootExposureEndpointUpdate</code></br>
<em>
boolean
</em>
</td>
<td>
<em>(Optional)</em>
<p>SelfHostedShootExposureEndpointUpdate indicates whether the extension requires the SelfHostedShootExposure endpoints to be continuously<br />updated with healthy/valid control plane endpoints.</p>
</td>
</tr>
